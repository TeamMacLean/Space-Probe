...
function buildComparison(currentFolder, previousFolder) {
    ...
    if (isNaN(currentFolder.size)) {
        console.log('NAD', currentFolder);
    }

    outputObject.sizePrevious = previousFolder.size;
    outputObject.sizeDifference = currentFolder.size - previousFolder.size;
    ...
    console.log(outputObject.name, currentFolder.size, previousFolder.size, outputObject.sizeDifference);
    return outputObject;
